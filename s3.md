...
For more advanced configurations and optimizations, you can also leverage features like CloudFront CDN integration, custom domain setup, and website redirection rules in Amazon S3
